# -*- coding: utf-8 -*-
"""
Created on Fri Apr  3 17:43:36 2020
...
cap = cv2.VideoCapture('D:\Dynamic Traffic Control\videos\overpass.mp4')
...
while True:
    ...
    _, contour, h = cv2.findContours(dilated,cv2.RETR_TREE,cv2.CHAIN_APPROX_SIMPLE)
